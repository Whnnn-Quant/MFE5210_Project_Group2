...
future_list = ['AG','AU','C','IF','NI','T','TA'] # 'SI','RB','I','J','JM',


Total_daily_rets = []
for future in future_list:
    data_path = f'/Users/wanghenan/港中深金工/Courses/AL_Trade/Project/data_1h_factor/{future}888_1h_signals.csv'
    ...
    strategy = Strategy_Multi_factors(engine)
